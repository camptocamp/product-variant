...
class TestProductVariantChangeAttributeValue(common.SavepointCase):
    ...
    def test_remove_attribute_value(self):
        ...
        self.assertFalse(self.is_attribute_value_on_template(self.variant_1, self.steel))
    ...
    def test_change_attribure_value(self):
        ...
        self.assertFalse(self.is_attribute_value_on_template(self.variant_1, self.white))
